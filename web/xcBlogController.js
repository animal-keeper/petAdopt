...
function editxcBlog(request, response) {
    ...
    request.on("data", function (data) {
        xcblogDao.insertxcBlog(params.title, tags,timeUtil.getNow(), timeUtil.getNow(),  data.toString(),params.emil,params.qq,params.ad,params.user_name,function (result) {
